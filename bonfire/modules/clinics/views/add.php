				...
				<div class="box box-warning" id="first_clinic_elements">
					<div class="box-body">
						<?php
							...
							echo form_open('clinics/add/', $attributes);
						?>
						<?php 
						...
						<div class="form-group">
							<div class="clone row custom-form">
								...
								<div class="col-md-4">	
									<input name="clinic_name" id="clinic_name" type="text" class="form-control" placeholder="Clinic Name" value="<?php echo set_value('clinic_name'); ?>"/>
						...
						<div class="form-group">
							<div class="row custom-form">
								...
								<div class="col-md-4">
									<input type="hidden" style="width: 100%" name="country" id="country" value="<?php set_value('country'); ?>">
						...
						<div class="form-group">
							<div class="row custom-form">
								...
								<div class="col-md-4">
									<input type="hidden" style="width: 100%" name="state" id="state" value="<?php set_value('state') ?>">	
						...
						<div class="form-group">
							<div class="row custom-form">
								...
								<div class="col-md-4">	
									<input type="hidden" style="width: 100%" name="city" id="city" value="<?php set_value('city') ?>">
						...
						<div class="form-group">
							<div class="clone row custom-form">
								...
								<div class="col-md-4">
									<textarea rows="3" cols="52" name="address_line1" id="address_line1"><?php echo set_value('address_line1'); ?></textarea>	
						...
						<div class="form-group">
							<div class="clone row custom-form">
								...
								<div class="col-md-4">
									<textarea class="mceEditor" rows="3" cols="52" name="address_line2" id="address_line2"><?php echo set_value('address_line2',isset($clinics['address_line2']) ? $clinics['address_line2'] : ''); ?></textarea>	
						...
						<div class="form-group">
							<div class="row custom-form">
			                	<div class="col-md-2">
                                 ...
                                 <div class="col-md-4">
		                            <input id='fees' class="fees form-control" type='text' name='fees' maxlength="100" value="<?php echo set_value('fees'); ?>" data-mask="000000"/>
		...
		jQuery("#map_canvas").dialog({
			...
			open: function( event, ui ) {
				$('#map_canvas').locationpicker({
				     location: 
				     {
				     	latitude: <?php if(set_value('latitude')) { echo  set_value('latitude'); } else { echo  24.59196503014968; } ?>, 
				     	longitude: <?php if(set_value('longitude')) { echo set_value('longitude'); } else { echo 73.72406077384949; } ?>
				     },
				     radius: 100,
				     inputBinding: {
