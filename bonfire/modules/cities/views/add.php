...
$state_record = isset($states) && is_array($states) && count($states);
				...
				<div class="box box-warning">
					<div class="box-body">
							<?php
								...
								echo form_open('cities/add', $attributes);
							?>
							<?php 
							...
							<div class="form-group">
								<div class="row custom-form">
									...
									<div class="col-md-4">	
										<input name="name" id="name" type="text" class="form-control" placeholder="City Name" value="<?php echo set_value('name', isset($cities['name']) ? $cities['name'] : ''); ?>"/>
