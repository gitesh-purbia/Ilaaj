				...
				<div class="box box-warning">
					<div class="box-body">
							<?php
								...
								echo form_open('degree/edit/'.$id, $attributes);
							?>
							...
							<div class="form-group">
								<div class="row custom-form">
									...
									<div class="col-md-4">	
										<input name="name" id="name" type="text" class="form-control" placeholder="Enter Degree" value="<?php echo set_value('name',$degree['name']); ?>"/>
