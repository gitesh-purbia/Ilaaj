				...
				<div class="box box-warning">
					<div class="box-body">
							<?php
								...
								echo form_open('specialities/add', $attributes);
							?>
							<?php 
							...
							<div class="form-group">
								<div class="row custom-form">
									...
									<div class="col-md-4">	
										<input name="name" id="name" type="text" class="form-control" placeholder="Enter Speciality" value="<?php echo set_value('name', isset($specialities['name']) ? $specialities['name'] : ''); ?>"/>
										<span class='text-red'><?php echo form_error('name'); ?></span>
									</div>
								</div>
							</div>
							<div class="box-footer">
								<input type="submit" name="save" class="btn btn-primary" value="Speciality Create"  />
								<?php echo lang('bf_or'); ?>
