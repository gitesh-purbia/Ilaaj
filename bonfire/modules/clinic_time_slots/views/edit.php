				...
				<div class="box box-warning" id="first_clinic_elements">
					<div class="box-body">
						<?php
							...
							echo form_open('clinic_time_slots/edit/'.$clinic_id, $attributes);
						?>
						<?php 
						...
						<div class="form-group" id="timeslots_monday">
							...
							<?php $count = 0; foreach($records as $record):
							 if($record->day =='monday'):
							 $count =  $count+1;
							 $divid = $count;	
							?>
							<div class="row custom-form" <?php if($count >1) echo "id=timeslots$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_monday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_monday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_monday[]' maxlength="100" value="<?php echo set_value('opening_time_monday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_monday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_monday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_monday[]' maxlength="100" value="<?php echo set_value('closing_time_monday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                     	</div><br/>
						...
						<div class="form-group" id="timeslots_tuesday">
							...
							<?php 
							 ...
							 $divid = $count;
							?>	
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_tuesday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_tuesday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_tuesday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_tuesday[]' maxlength="100" value="<?php echo set_value('opening_time_tuesday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_tuesday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_tuesday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_tuesday[]' maxlength="100" value="<?php echo set_value('closing_time_tuesday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_tuesday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php 
						...
						<div class="form-group" id="timeslots_wednesday">
							...
							<?php $count =0; foreach($records as $record): 
							 ...
							 $divid = $count;	
							?>		
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_wednesday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_wednesday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_wednesday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_wednesday[]' maxlength="100" value="<?php echo set_value('opening_time_wednesday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_wednesday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_wednesday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_wednesday[]' maxlength="100" value="<?php echo set_value('closing_time_wednesday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_wednesday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php endif; endforeach; ?>
						...
						<div class="form-group" id="timeslots_thursday">
							...
							<?php $count =0; foreach($records as $record): 
							 ...
							 $divid = $count;		
							?>		
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_thursday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_thursday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_thursday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_thursday[]' maxlength="100" value="<?php echo set_value('opening_time_thursday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_thursday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_thursday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_thursday[]' maxlength="100" value="<?php echo set_value('closing_time_thursday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_thursday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php endif; endforeach; ?>
						...
						<div class="form-group" id="timeslots_friday">
							...
							<?php $count =0; foreach($records as $record): 
							 ...
							 $divid = $count;	
							?>		
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_friday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_friday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_friday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_friday[]' maxlength="100" value="<?php echo set_value('opening_time_friday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_friday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_friday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_friday[]' maxlength="100" value="<?php echo set_value('closing_time_friday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_friday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php endif; endforeach; ?>
						...
						<div class="form-group" id="timeslots_saturday">
							<div class="row custom-form">
								<div class="col-md-12">
									<h3>Saturday<span style="font-size: 12px;"><a href="javascript:void(0)" id="samefriday">(Same as Friday)</span></a></h3>
								</div>
							</div>
							<?php $count =0; foreach($records as $record): 
							 ...
							 $divid = $count;	
							?>			
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_saturday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_saturday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_saturday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_saturday[]' maxlength="100" value="<?php echo set_value('opening_time_saturday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_saturday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_saturday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_saturday[]' maxlength="100" value="<?php echo set_value('closing_time_saturday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_saturday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php endif; endforeach; ?>
						...
						<div class="form-group" id="timeslots_sunday">
							...
							<?php $count =0; foreach($records as $record): 
							 ...
							 $divid = $count;		
							?>	
							<div class="row custom-form" <?php if($divid >1) echo "id=timeslots_sunday$divid"; ?>>
			                	<div class="col-md-2">
									<label for="opening_time_sunday">Timings*</label>
								</div>
                                <div class="col-md-2">
		                            <input id="opening_time_sunday" placeholder="Opening Time" class="opening_time form-control" type='text' name='opening_time_sunday[]' maxlength="100" value="<?php echo set_value('opening_time_sunday[]', isset($record->time_from)?$record->time_from:''); ?>" />
									<span class='text-red'><?php echo form_error('opening_time_sunday[]'); ?></span>
								</div>
								<div class="col-md-2">
		                            <input id='closing_time_sunday' placeholder="Closing Time" class="closing_time form-control" type='text' name='closing_time_sunday[]' maxlength="100" value="<?php echo set_value('closing_time_sunday[]', isset($record->time_to)?$record->time_to:''); ?>" />
								...
								<?php else:?>
								<div class="col-md-2">
									<button type="button" <?php if($count >1) echo "id=delete_timeslots_sunday$divid"; ?> onclick="delete_timeslot(this.id)" class="btn btn-danger">Delete</button>
								</div>
								<?php endif;?>	
	                       </div><br/>
	                       <?php endif; endforeach; ?>
