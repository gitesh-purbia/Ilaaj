...
<body class="skin-blue">
	<div class="wrapper">
		<header class="main-header">
			<a href="<?php echo site_url(); ?>" class="logo"><b>Ilaaj</b></a>
								...
								<li>
									<ul class="menu">
										...
										<li>
											<a href="#">
											<div class="pull-left">
												<img src="<?php echo Template::theme_url('images/user3-128x128.jpg') ?>" class="img-circle" alt="user image"/>
										...
										<li>
											<a href="#">
											<div class="pull-left">
												<img src="<?php echo Template::theme_url('images/user4-128x128.jpg') ?>" class="img-circle" alt="user image"/>
